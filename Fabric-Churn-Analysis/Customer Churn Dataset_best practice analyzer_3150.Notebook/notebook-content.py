...
dataset = "Customer Churn Dataset" # Enter the name or ID of the semantic model
workspace = "[FCE] Open Hack - Bank Customer Churn Analysis" # Enter the workspace name or ID in which the semantic model exists
